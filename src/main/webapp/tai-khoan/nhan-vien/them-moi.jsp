<%@ page contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    ...
    <head>
        ...
        <title>Thêm Nhân Viên - RunMax Admin</title>
        <meta name="description" content="Thêm nhân viên mới vào hệ thống RunMax">
            ...
            <div class="main-content">
                ...
                <div class="page-content">
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-row">
                            <div class="form-group full-width">
                                <input type="text" class="form-input" id="tenDangNhap" placeholder="Tên đăng nhập">
                            </div>
                        </div>

                        <div class="form-row">
                            <div class="form-group full-width">
                                <input type="password" class="form-input" id="matKhau" placeholder="Mật khẩu">
                            </div>
                        </div>
                        ...
                        <div class="form-actions">
                            <button type="button" class="btn-submit" id="btnThemNhanVien">Thêm</button>
                            <a href="${pageContext.request.contextPath}/tai-khoan/nhan-vien/danh-sach.jsp?activePage=tai-khoan&activeSubmenu=nv"
