...
<div class="admin-wrapper">
    ...
    <jsp:include page="/includes/sidebar.jsp">
        ...
        <jsp:param name="activeSubmenu" value="thuong-hieu" />
    </jsp:include>
        ...
        <div class="page-content" style="padding: 24px 32px;">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    ...
                    <p class="text-secondary mb-0" style="font-size: 14px;">Quản lý danh mục các thương hiệu giày sneaker</p>
                </div>
                    ...
                    <form action="${pageContext.request.contextPath}/admin/thuong-hieu" method="GET" class="row g-3 mb-4">
                        <div class="col-md-5">
                            <div class="input-group">
                                ...
                                <input type="text" name="keyword" class="form-control bg-light border-start-0" placeholder="Tìm kiếm theo tên thương hiệu..." value="${keyword}">
                            </div>
                        </div>
                        <div class="col-md-2">
                                ...
                                <tr>
                                    ...
                                    <td class="text-end">
                                        ...
                                        <form action="${pageContext.request.contextPath}/admin/thuong-hieu/toggle-status" method="POST" class="d-inline">
                                            ...
                                            <button type="submit" class="btn btn-sm ${th.trangThai == 1 ? 'btn-outline-danger' : 'btn-outline-success'}">
