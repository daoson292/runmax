<%@ page contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    ...
    <head>
        ...
        <title>Cập Nhật Nhân Viên - RunMax Admin</title>
        <meta name="description" content="Cập nhật thông tin nhân viên RunMax">
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-row">
                            <div class="form-group full-width">
                                <input type="text" class="form-input" id="hoTen" placeholder="Họ và tên" value="Nguyễn Văn An">
                            </div>
                        </div>

                        <div class="form-row">
                            <div class="form-group full-width">
                                <input type="email" class="form-input" id="email" placeholder="Email" value="an.nv@runmax.vn">
                            </div>
                        </div>

                        <div class="form-row">
                            <div class="form-group full-width">
                                <input type="tel" class="form-input" id="soDienThoai" placeholder="Số điện thoại" value="0901234567">
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="form-group full-width">
                                <select class="form-select" id="phuongXa">
                                    ...
                                    <option value="dich-vong" selected>Dịch Vọng</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="form-group full-width">
                                <input type="text" class="form-input" id="diaChiCuThe" placeholder="Địa chỉ cụ thể" value="Số 10, Ngõ 5, Đường Trần Thái Tông">
                            </div>
                        </div>
