...
VALUES
    ...
    -- Hóa đơn hủy
    (4, 16, 1, 3190000, 3190000, 1), -- HD00007
    (5, 5, 1, 2590000, 2590000, 1),  -- HD00008
    -- Hóa đơn thiếu
    (6, 10, 1, 3990000, 3990000, 1), -- HD00009
    (7, 9, 2, 2500000, 5000000, 1), -- HD00010
    -- Hóa đơn hoàn thành mới
    (8, 1, 1, 2490000, 2490000, 1), -- HD00011
    (9, 9, 1, 3290000, 3290000, 1); -- HD00012
...
VALUES
    ...
    -- HD00009 trả thiếu
    (6, 1, 1000000, '2026-05-02 11:05:00', 1),
    (6, 2, 2000000, '2026-05-02 11:10:00', 1), -- Tổng 3tr/3tr990
    -- HD00010 trả thiếu
    (7, 3, 4000000, '2026-05-02 14:25:00', 1), -- Tổng 4tr/4tr700
    -- HD00011 hoàn thành
    (8, 4, 2490000, '2026-05-03 15:50:00', 1),
    -- HD00012 hoàn thành
    (9, 5, 3290000, '2026-05-03 16:15:00', 1);
...
VALUES
    ...
    (4, N'khanh', N'Tạo hóa đơn HD00007', '2026-05-01 09:00:00'),
    (4, N'khanh', N'Hủy hóa đơn do khách đổi ý', '2026-05-01 09:10:00'),
    (5, N'khanh', N'Tạo hóa đơn HD00008', '2026-05-01 10:30:00'),
    (5, N'khanh', N'Hủy hóa đơn do sai sản phẩm', '2026-05-01 10:35:00'),
    (6, N'thuhang', N'Tạo hóa đơn HD00009', '2026-05-02 11:00:00'),
    (6, N'thuhang', N'Khách thanh toán một phần bằng tiền mặt', '2026-05-02 11:05:00'),
    (6, N'thuhang', N'Khách chuyển khoản phần lớn', '2026-05-02 11:10:00'),
    (7, N'thuhang', N'Tạo hóa đơn HD00010', '2026-05-02 14:20:00'),
    (7, N'thuhang', N'Khách quẹt thẻ thanh toán 4tr', '2026-05-02 14:25:00'),
    (8, N'banhang', N'Tạo hóa đơn HD00011', '2026-05-03 15:45:00'),
    (8, N'banhang', N'Khách thanh toán qua MoMo', '2026-05-03 15:50:00'),
    (9, N'banhang', N'Tạo hóa đơn HD00012', '2026-05-03 16:10:00'),
    (9, N'banhang', N'Khách thanh toán qua VNPay', '2026-05-03 16:15:00');
GO
